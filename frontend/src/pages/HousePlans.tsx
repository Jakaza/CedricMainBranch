...
import { useHousePlans } from '@/hooks/useProperties';
...
export const HousePlans = () => {
  ...
  // Fetch house plans from API
  const { data: housePlans = [], isLoading, error } = useHousePlans();
  ...
  const filteredAndSortedPlans = useMemo(() => {
    ...
    return filtered;
  }, [housePlans, filters, sortBy, searchQuery]);
      ...
      <>
        ...
        <div className="min-h-screen bg-background flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground">Loading house plans...</p>
          </div>
        </div>
      </>
    );
      ...
      <>
        ...
        <div className="min-h-screen bg-background flex items-center justify-center">
          <div className="text-center max-w-md mx-auto p-6">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-2">Failed to Load House Plans</h2>
